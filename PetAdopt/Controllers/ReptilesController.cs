...
namespace PetAdopt.Controllers
{
    public class ReptilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReptileId,Name,Image,NeededHabitat,NeededFood,Age,Gender,RecentCheckup,About")] Reptile reptile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReptileId,Name,Image,NeededHabitat,NeededFood,Age,Gender,RecentCheckup,About")] Reptile reptile)
        {
            if (ModelState.IsValid)
            {
